...
def generate_true_false(scene_probability=[0.23,0.77], num=4):
    ...
    print(f"Probability of True: {scene_probability[0]*100:.2f}%")
    scenarios = [
...
def simulate_investor(
    ...
    for simulation in range(1, simulations + 1):
        # generate scenarios with probability 0.5
        scenarios = generate_true_false([probability,1-probability], simulations)
        # if True, add value of startup to total
